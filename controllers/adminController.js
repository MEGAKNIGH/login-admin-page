...
const addUser = async (req, res) => {
    ...
    //   console.log(req.body);
      if(!/^\d{10}$/.test(user.mobile)){
          return res.render("new-user",{message:"Mobile number must be 10 digits"})
      }
     if(name.trim() === ""){
          return res.render("new-user",{message:"Name must be fill"})
      }
      ...
      console.log(error.message);
      return res.render("new-user",{message:"All field should be filled"})
    }
  };
